...
#🔻🔻🔻🔻🔻
title: "Login.gov Senior Policy Lead"
...
#🔻🔻🔻🔻🔻
key objectives:
  - Advise and coordinate government-wide digital identity policy 
    ...
    - Formulates and advocates for digital identity policy recommendations and guidance that support Login.gov and government operated digital identity priorities.
    - Represents Login.gov in and when appropriate, leads interagency discussions on digital identity, digital experience, cybersecurity, and federal identity, credential, and access management architecture.
    - Develops, presents, and leads discussion with senior government executives, including CIOs, CISOs, and OMB officials, on modern digital identity processes and policy needs.
    - Works with technology executives and senior-level managers throughout the Federal government to promote adherence to the critical elements of the Federal ICAM Architecture and provide expert technical implementation assistance to other Federal agencies.
  - Serves as digital identity policy subject matter expert
    - Develops definitive policy recommendations based on extensive analysis including consultation with agency partners in coordination with Login’s Partner Advisory Group; References such as industry reports, various agency Office of Inspector General reports, Comptroller General and Government Accountability Office (GAO) audit decisions, other legal precedents; External stakeholders including, where appropriate, relevant advocacy, non-profit, and industry entities.
    - Ensures findings and policy recommendations remain in conformance with ongoing governmental, presidential, and/or congressional initiatives.
    - Respond to Login.gov team requests related to digital identity requirements.
    - Provide technical assistance on relevant legislative and other policy proposals.
    - Assists and trains new Login.gov team members in digital identity guidelines (i.e., National Institute of Standards and Technology (NIST) Special Publication (SP) 800-63, digital identity policy) and processes.
...
🔻🔻🔻🔻🔻
{% endcomment --------------------------------------------------------------- %}
**Official title in USAJOBS:** IT Specialist (INFOSEC/PLCYPLN)
...
The Login.gov Senior Policy Lead serves as the senior digital identity technical subject matter expert to research sensitive, complex, and/or emerging technology patterns within the landscape of digital identity disciplines and lead various digital identity initiatives based on that research. The Policy Lead’s primary responsibility is advising and coordinating government-wide digital identity policies and collaborating with federal executive branch agencies on implementation of guidance. This individual will, in coordination with GSA Office of General Council, act as the organization’s primary expert for NIST 800-63 identity verification compliance and will assist with monitoring, evaluating, and supporting the various workstreams for Login.gov to achieve and maintain IAL2 compliance.  

The lead will monitor and advise on policy development and implementation, work closely with the Login.gov management team and the TTS technology policy lead to identify emerging and existing policies relevant to Login.gov and coordinate to ensure policy consistency with TTS and GSA. This includes providing technical assistance and feedback on draft legislation, policies and implementation guidance as well as insight into existing policies for Login.gov. They will lead or conduct development of technical policies internal to Login.gov for digital identity matters, such as re-proofing and data privacy. The work includes developing briefings or standardized procedures on the interpretation of governing policy in assigned Login.gov IT policy, planning, and secure identity access program functions; assisting partners in their use of Login.gov; analysis of operational and technical issues impacting interoperability across agency implementations and proposing solutions to address the issues; and participation in government working groups dealing with digital experience, digital identity, and high impact service providers.
