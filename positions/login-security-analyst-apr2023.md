...
#🔻🔻🔻🔻🔻
title: "Login.gov: Security Engineer Technical Expert - Analyst"
...
key objectives:
  - Contribute to Login.gov’s Cybersecurity Practice
    ...
    defending against, or responding to security incidents.
    - Automate data analytics or security processes by using object-oriented 
    languages (e.g., Python).
    - Collaborate with application development teams, platform engineers, and 
    Security Operations Center (SOC) engineers to build and implement security 
    in an open source, live services environment.
    - Collaborate with User Experience, Infrastructure, and Application Developer 
    Engineers to ensure changes to Login.gov’s product or infrastructure do not 
  ...
  - Provide subject matter expertise on cybersecurity practices to Login.gov Leadership
    ...
    - Develop standard operating procedures that improve Login.gov’s cybersecurity 
    posture.  
