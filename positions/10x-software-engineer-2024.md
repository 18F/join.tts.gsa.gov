...
Currently, around 15% of the 10x investment pipeline entails potential AI solutions, though we expect this number to grow steadily over time. Put another way, 15% of our work relates to problems which might admit to solutions involving ML, NLP and related technologies, but which also might be effectively solved with more conventional tools. As a principal engineer at 10x, you will be expected to know the difference, and to be capable of bringing software solutions from concept through MVP and to validation in the market, regardless of the underlying technology required. 
