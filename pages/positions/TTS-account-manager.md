---
title: Technology Transformation Services (TTS) - Account manager / Project coordinator
...
{% if page.state != 'upcoming' %}
  {{ page.org }} is hiring for the role of GS-{{ page.gs_level }} - {{ page.role_name }}. **Several units within TTS are hiring for this role**. This page contains a high-level summary of the role, a link to submit your application, and links to more specific descriptions within each TTS unit. 
  **If you apply for this position you will be considered for all open Account manager / Project coordinator roles within TTS.**

  Attend an information session to learn more about this role, working at TTS, and our application process. Register for a session using the Eventbrite links below.
   - XXX
   - XXX
{% endif %}
