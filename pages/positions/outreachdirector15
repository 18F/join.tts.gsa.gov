---
layout: job-updated
title: Outreach Director GS15
permalink: /join/outreachdirector15/
state: draft 
job_post_type: usajobs

# INSTRUCTIONS UPCOMING: These fields are required for upcoming
role_name: Outreach Director GS15
opens: 'tbd' 
closes: 'tbd'
weeks_open: 'TBD'
location: 'virtual'
...
pd_job_title: 'TBD PD not yet created'
num_vacancies: '1'
series: 'TBD PD not yet created, likely 0301'
apply_url: 'TBD'
...
- TBD once Cristina Brydges provides them
- 
- 
- 
